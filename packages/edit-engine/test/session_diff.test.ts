...
describe('Session Diff & Persistence', () => {
    ...
    // Data
    const s1 = BigInt(10); const p1 = BigInt(11); const o1 = BigInt(12);
    const s2 = BigInt(20); const p2 = BigInt(21); const o2 = BigInt(22);
    const diffGraph = BigInt(999); // Mock ID for diff graph loc

    let diffStore: QuadStore;
    let strategy: DefaultCommitStrategy;
    ...
    it('Scenario: Delete in Session 1, Add in Session 2, Export Diff', async () => {
        ...
        // ?x a ag:Deletion
        let deletionNode: bigint | null = null;
