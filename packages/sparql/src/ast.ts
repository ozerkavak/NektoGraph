...
export interface InsertDeleteOperation {
    ...
    delete?: BgpPattern[];
    where?: Pattern[];
    graph?: string; // For LOAD/CLEAR etc, but maybe distinct types later
}
...
export function isTriple(term: any): term is TripleTerm {
...
export interface ValuesPattern {
    type: 'values';
    values: { [key: string]: Term | undefined }[];
}
...
export function isPropertyPath(term: any): term is PropertyPath {
